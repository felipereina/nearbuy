...
import { updateStoreEmail, updateStorePassword, updateStoreName, signupStore, updateStorePhoto, updateStore } from '../actions/store'
    ...
    return (
      <View style={[styles.container, styles.center]}>
        <TouchableOpacity style={styles.center} onPress={this.openLibrary} >
          <Image style={styles.roundImage} source={{uri: this.props.store.photo}}/>
...
const mapDispatchToProps = (dispatch) => {
    return bindActionCreators({updateStorePhoto, uploadPhoto, updateStore, updateStoreEmail, updateStorePassword, updateStoreName, signupStore}, dispatch)
}
...
export default connect(mapStateToProps, mapDispatchToProps)(StoreSignup);